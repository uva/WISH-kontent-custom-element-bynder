    ...
    onSuccess: function (selectedAssets) {
      ...
      for (const asset of selectedAssets) {
        ...
        assets.push({
          ...
          previewUrl: asset.files[config.previewDerivative || "thumbnail"] == undefined ? '' : asset.files[config.previewDerivative || "thumbnail"].url,
          webUrl: asset.files[config.previewDerivative || "webImage"] == undefined ? '' : asset.files[config.previewDerivative || "webImage"].url,
          files: asset.files,
          type: asset.type,
